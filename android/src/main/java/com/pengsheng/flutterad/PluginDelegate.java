...
import com.pengsheng.flutterad.page.AdSplashActivity;
import com.pengsheng.flutterad.view.InterstitialPage;
import com.pengsheng.flutterad.base.NativeViewFactory;
import com.pengsheng.flutterad.view.FullScreenVideoPage;
...
import com.pengsheng.flutterad.view.RewardVideoPage;
...
public class PluginDelegate implements MethodChannel.MethodCallHandler, EventChannel.StreamHandler {
    ...
    // Banner View
    public static final String KEY_BANNER_VIEW = "flutterad_banner";
    // Splash View
    public static  final  String KEY_SPLASH_VIEW = "flutterad_splash";
    // Feed view
    public static  final String KEY_Feed_View = "flutterad_feed_view";
    // Full view
    public static  final String KEY_Full_View = "KEY_Full_View";
    // 广告参数
    ...
    public void registerSplashView() {
        bind.getPlatformViewRegistry().registerViewFactory(KEY_SPLASH_VIEW,new NativeViewFactory(KEY_SPLASH_VIEW,this));
    }
    ...
    public void  registerFeedView() {
        bind.getPlatformViewRegistry().registerViewFactory(KEY_Feed_View,new NativeViewFactory(KEY_Feed_View,this));
    }
